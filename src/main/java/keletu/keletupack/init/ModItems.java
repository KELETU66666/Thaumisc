...
public class ModItems {
    ...
    public static final Item.ToolMaterial MATERIAL_ICHORIUM = EnumHelper.addToolMaterial("ichorium", 10, -1, 5.0F, 4.0F, 22);
    ...
    public static final ItemSpade IchoriumShovelAdv = new IchoriumShovelAdv("ichorium_shovel_adv", CreativeTabs.TOOLS, MATERIAL_ICHORIUM);
}