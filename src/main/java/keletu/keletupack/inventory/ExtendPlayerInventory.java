package keletu.keletupack.inventory;
 ...
 * Author: MrCrayfish
 */
public class ExtendPlayerInventory extends InventoryPlayer
{
    ...
    public ExtendPlayerInventory(EntityPlayer player)
    {
        super(player);
    }
    ...
    public void copyBackpack(ExtendPlayerInventory inventory)
    {
